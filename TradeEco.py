...
# data = json.dumps(df, sort_keys=True, indent=4)
# with open('Hose data.json','w') as outfile:
#     outfile.write(data)
#Giu lai time, a (ma co phieu), b (gia dong cua: closed price), 
# v (gia cao nhat: highest price), w (lowest price), n(khoi luong giao dich trong phien)
